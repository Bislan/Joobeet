...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_1' => 'getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba341Service',
            'fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_2' => 'getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba342Service',
            'fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_3' => 'getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba343Service',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/root/htdocs/www/Joobeet/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/root/htdocs/www/Joobeet/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/root/htdocs/www/Joobeet/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/root/htdocs/www/Joobeet/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'joobeet', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_cb691a450a49de960dc2245d63afeca38e6d90f3a259090b783640b4a3627180');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_cb691a450a49de960dc2245d63afeca38e6d90f3a259090b783640b4a3627180');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_cb691a450a49de960dc2245d63afeca38e6d90f3a259090b783640b4a3627180');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('F:\\root\\htdocs\\www\\Joobeet\\src\\Ens\\JobeetBundle\\Resources\\config\\doctrine' => 'Ens\\JobeetBundle\\Entity'));
        ...
        $f->setProxyDir('F:/root/htdocs/www/Joobeet/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba341Service()
    {
        return $this->services['fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }
    protected function getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba342Service()
    {
        return $this->services['fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }
    protected function getFcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba343Service()
    {
        return $this->services['fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    protected function getFileLocatorService()
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/root/htdocs/www/Joobeet/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('F:/root/htdocs/www/Joobeet/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/root/htdocs/www/Joobeet/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/root/htdocs/www/Joobeet/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_1'), 1 => $this->get('fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_2'), 2 => $this->get('fcd804ed391f7b867b40eadcecba1e1d23ea946c0c4138bcb61f261d21dfba34_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/root/htdocs/www/Joobeet/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/root/htdocs/www/Joobeet/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\src\\Ens\\JobeetBundle/Resources/views', 'EnsJobeet');
        $instance->addPath('F:/root/htdocs/www/Joobeet/app/Resources/views');
        $instance->addPath('F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'F:\\root\\htdocs\\www\\Joobeet\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/root/htdocs/www/Joobeet/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/root/htdocs/www/Joobeet/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/root/htdocs/www/Joobeet/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'F:/root/htdocs/www/Joobeet/app/cache/prod',
            'kernel.logs_dir' => 'F:/root/htdocs/www/Joobeet/app/logs',
            ...
            'session.save_path' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/sessions',
            ...
            'router.resource' => 'F:/root/htdocs/www/Joobeet/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'F:/root/htdocs/www/Joobeet/app/../web',
            'assetic.write_to' => 'F:/root/htdocs/www/Joobeet/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/root/htdocs/www/Joobeet/app/cache/prod/doctrine/orm/Proxies',
